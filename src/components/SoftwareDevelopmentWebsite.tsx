...
import { ArrowRight, ChevronRight, Menu, X, Calculator, Zap, ShieldCheck, Clock } from "lucide-react"
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground text-sm">Умный расчёт зарплаты для руководителей</span>
                  ...
                  <p className="mx-auto mt-8 max-w-2xl text-balance text-lg text-muted-foreground">
                    Сервис для руководителей подразделений: автоматизируйте начисление зарплаты, контролируйте фонд оплаты труда и забудьте о ручных ошибках в расчётах.
                  </p>
                </AnimatedGroup>
                ...
                <div className="group relative m-auto max-w-5xl px-6">
                  <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
                    <a href="#contact" className="block text-sm duration-150 hover:opacity-75 text-orange-500">
                      <span>Начать расчёт прямо сейчас</span>
          ...
          <div className="mx-auto max-w-5xl px-6">
            <div className="text-center">
              <h2 className="text-balance text-4xl font-semibold lg:text-5xl">
                Почему выбирают <span className="text-orange-500">ЗарплатаПро</span>
              </h2>
              <p className="mt-4 text-muted-foreground">
                Сервис создан специально для руководителей подразделений, которые хотят тратить меньше времени на расчёты и больше — на управление командой.
              </p>
            </div>
            <Card className="mx-auto mt-8 grid max-w-sm divide-y overflow-hidden shadow-zinc-950/5 border-orange-200 *:text-center md:mt-16 md:max-w-full md:grid-cols-3 md:divide-x md:divide-y-0">
              <div className="group shadow-zinc-950/5">
                <CardHeader className="pb-3">
                  ...
                  <h3 className="mt-6 font-medium">Мгновенный расчёт</h3>
                </CardHeader>

                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Расчёт зарплаты для всего подразделения занимает минуты. Никаких Excel-таблиц и ручного ввода данных.
                  </p>
                </CardContent>
              </div>
              ...
              <div className="group shadow-zinc-950/5">
                <CardHeader className="pb-3">
                  ...
                  <h3 className="mt-6 font-medium">Точность и контроль</h3>
                </CardHeader>

                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Автоматическая проверка расчётов исключает ошибки. Полная прозрачность по каждому сотруднику и показателю.
                  </p>
                </CardContent>
              </div>
              ...
              <div className="group shadow-zinc-950/5">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Руководители экономят до 8 часов в месяц на расчётах и согласованиях. Больше времени — на развитие команды.
                  </p>
                </CardContent>
              </div>
            </Card>
        ...
        <div className="mx-auto max-w-7xl py-16 px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="space-y-4 sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-sm text-muted-foreground max-w-xs">
                Сервис автоматизации расчёта зарплаты для руководителей подразделений. Точно, быстро, без ошибок.
              </p>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                <li className="flex items-center space-x-2">
                  ...
                  <span className="break-all">info@zarplatapro.ru</span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg className="h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
          ...
          <div className="mt-12 pt-8 border-t border-orange-200">
            <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
              <div className="text-sm text-muted-foreground">2024 ЗарплатаПро. Все права защищены.</div>
